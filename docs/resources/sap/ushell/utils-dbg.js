...
sap.ui.define([
            ...
            sap.ui.require(["sap/ui/VersionInfo"], function (VersionInfo) {
                VersionInfo.load().then(
                    function (oVersionInfo) {
                        ...
                        Log.error("sap ui version could not be determined, using sap.ui.version (core version) as fallback");
                        resolve(_extractUi5Version(sap.ui.version));
                    });
            });
        });
    };
    ...
    utils.getUi5Version = function () {
        ...
        try { // in the sandbox localhost scenario, "sap.ui.getVersionInfo()" triggers an exception
            ...
            Log.error("sap ui version could not be determined, using sap.ui.version (core version) as fallback " + e);
