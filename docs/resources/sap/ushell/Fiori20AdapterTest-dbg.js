...
sap.ui.define([
...
], function (UriParameters, UIComponent, Fiori20Adapter, coreLibrary, ServiceFactoryRegistry, Log, Version, isEmptyObject) {
    "use strict";
    ...
    var Fiori20AdapterConfiguration = {
        ...
        _getMetadataConfiguration: function (oComp) {
            ...
            } else if ((typeof oAppConfig === "object") && !isEmptyObject(oAppConfig)) {
            ...
            return {
                ...
                bLateAdaptation: aAppConfig ? this._isSgnTrue(aAppConfig.lateAdaptation) : Fiori20AdapterConfiguration.B_DEFAULT_LATE_ADAPTATION
            };
        },
        ...
        _hasMinVersionSmallerThan: function (oComp, sVersion) {
            var oInfo = oComp.getMetadata().getManifestEntry("sap.ui5"),
                bMinVersion = true; //by default considered smaller unless otherwise specified (to cover old apps w/o min version)
