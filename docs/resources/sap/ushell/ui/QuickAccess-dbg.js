...
sap.ui.define([
    ...
    var oQuickAccess = {
            ...
            return Fragment.load({
                ...
                this.oQuickAccessDialog.attachAfterClose(function () {
                    ...
                    if (Device.system.desktop) {
                        var oFocusElement = sap.ui.getCore().byId(sFocusIdAfterClose);
        ...
        _updateQuickAccessDialog: function (oDialog) {
            ...
            return sap.ushell.Container.getServiceAsync("UserRecents").then(function (oUserRecentsSrvc) {
                return Promise.all([
                    new Promise(function (resolve) {
                        oUserRecentsSrvc.getRecentActivity().then(
                    ...
                    new Promise(function (resolve) {
                        oUserRecentsSrvc.getFrequentActivity().then(
                            function (aActivity) {
                                resolve(aActivity);
                            },
                            function () {
