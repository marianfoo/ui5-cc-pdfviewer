...
sap.ui.define([
     ...
     * - Description, help-id and icon of a menu item are not exposed by the
     ...
     *   Pages which belong to a different space than the top level menu entry indicates will therefore be part of this space instead of their space set by the spaceId parameter.
     *
