...
sap.ui.define(["../core/core", "./Query", "./SuggestionType", "./SuggestionCalculationMode", "./DataSourceType", "../core/errors"], function (core, ___Query, ___SuggestionType, ___SuggestionCalculationMode, ___DataSourceType, ___core_errors) {
  ...
  var SuggestionQuery = /*#__PURE__*/function (_Query) {
    ...
    function SuggestionQuery(properties) {
      ...
      _this4 = _super.call(this, properties);

      _defineProperty(_assertThisInitialized(_this4), "calculationModes", [SuggestionCalculationMode.Data, SuggestionCalculationMode.History]);

      _defineProperty(_assertThisInitialized(_this4), "types", [SuggestionType.DataSource, SuggestionType.Object, SuggestionType.SearchTerm]);

      _this4.types = (_properties$types = properties.types) !== null && _properties$types !== void 0 ? _properties$types : _this4.types;
      _this4.calculationModes = (_properties$calculati = properties.calculationModes) !== null && _properties$calculati !== void 0 ? _properties$calculati : _this4.calculationModes;
      return _this4;
    }
    ...
    _createClass(SuggestionQuery, [{
      ...
      value: function _formatResultSetAsync(resultSet) {
        ...
        return _call(function () {
          ...
          return query.types.indexOf(SuggestionType.Object) >= 0 && query.filter.dataSource.type === query.sina.DataSourceType.BusinessObject ? _await(core.executeSequentialAsync(_this.sina.suggestionResultSetFormatters, function (formatter) {
      ...
      value: function _execute(query) {
        ...
        return _call(function () {
          return _await(_this2._doExecuteSuggestionQuery(query));
        });
      }
    }, {
      ...
      value: function _doExecuteSuggestionQuery(query) {
        ...
        return _call(function () {
          ...
          return _await(_this3.sina.provider.executeSuggestionQuery(transformedQuery), function (resultSet) {
