...
sap.ui.define(["./DataSourceType", "./FacetQuery"], function (___DataSourceType, ___FacetQuery) {
  ...
  var HierarchyQuery = /*#__PURE__*/function (_FacetQuery) {
    ...
    function HierarchyQuery(properties) {
      ...
      _this3.top = (_properties$top = properties.top) !== null && _properties$top !== void 0 ? _properties$top : 30;
      _this3.attributeId = properties.attributeId;
      _this3.nodeId = properties.nodeId;
      return _this3;
    }
    ...
    _createClass(HierarchyQuery, [{
      ...
      value: function _execute(query) {
        ...
        return _call(function () {
          return _await(_this._doExecuteHierarchyQuery(query));
        });
      }
    }, {
      ...
      value: function _doExecuteHierarchyQuery(query) {
        ...
        return _call(function () {
          ...
          return _await(_this2.sina.provider.executeHierarchyQuery(transformedQuery), function (resultSet) {
