...
sap.ui.define([], function () {
  ...
  var _normalizeConfiguration = _async(function (configuration) {
    var _exit = false; // check whether configuration is a string with a javascript module name

    return _invoke(function () {
      if (typeof configuration === "string") {
        configuration = configuration.trim(); // configuration is a string with a url -> load configuration dynamically via require
        ...
        return _invoke(function () {
          ...
          if (_exit) return _result; // configuration is a string with the provider name -> assemble json
