...
sap.ui.define(["../core/core", "./Query", "./EqualsMode", "./ConditionType", "./DataSourceType", "../core/errors", "./ComparisonOperator"], function (core, ___Query, ___EqualsMode, ___ConditionType, ___DataSourceType, ___core_errors, ___ComparisonOperator) {
  ...
  var SearchQuery = /*#__PURE__*/function (_Query) {
    ...
    function SearchQuery(properties) {
      ...
      _this7 = _super.call(this, properties);

      _defineProperty(_assertThisInitialized(_this7), "calculateFacets", false);

      _defineProperty(_assertThisInitialized(_this7), "multiSelectFacets", false);

      _defineProperty(_assertThisInitialized(_this7), "nlq", false);

      _defineProperty(_assertThisInitialized(_this7), "facetTop", 5);

      _this7.calculateFacets = (_properties$calculate = properties.calculateFacets) !== null && _properties$calculate !== void 0 ? _properties$calculate : _this7.calculateFacets;
      _this7.multiSelectFacets = (_properties$multiSele = properties.multiSelectFacets) !== null && _properties$multiSele !== void 0 ? _properties$multiSele : _this7.multiSelectFacets;
      _this7.nlq = (_properties$nlq = properties.nlq) !== null && _properties$nlq !== void 0 ? _properties$nlq : _this7.nlq;
      _this7.facetTop = (_properties$facetTop = properties.facetTop) !== null && _properties$facetTop !== void 0 ? _properties$facetTop : _this7.facetTop;
      _this7.groupBy = (_properties$groupBy = properties.groupBy) !== null && _properties$groupBy !== void 0 ? _properties$groupBy : _this7.groupBy;
      return _this7;
    }
    ...
    _createClass(SearchQuery, [{
      ...
      value: function _execute(query) {
        ...
        return _call(function () {
          ...
          var chartQueries = []; // multi select facets: assemble chart queries for all facets with set filters
          ...
          if (_this.multiSelectFacets) {
            // collect attribute for which filters are set
            filterAttributes = _this._collectAttributesWithFilter(query); // create chart queries for filterAttribute

            chartQueries = _this._createChartQueries(query, filterAttributes);
          } // fire all requests


          var requests = [];
          var delayedCharQueries = [];
          requests.push(_this._executeSearchQuery(query));
          ...
          return _await(Promise.all(requests), function (results) {
            ...
            return _await(Promise.all(delayedChartQueryRequests), function (delayedCharQueryResults) {
              ...
              _this._mergeFacetsToSearchResultSet(searchResult, chartResultSets);
      ...
      value: function _executeSearchQuery(query) {
        ...
        return _call(function () {
          if (query.filter.isFolderMode()) {
            return _await(_this2._executeSearchQueryInFolderMode(query));
          } else {
            return _await(_this2._executeSearchQueryInSearchMode(query));
          }
      ...
      value: function _executeSearchQueryInSearchMode(query) {
        ...
        return _call(function () {
          return _await(_this3._doExecuteSearchQuery(query));
        });
      }
    }, {
      ...
      value: function _executeSearchQueryInFolderMode(query) {
        ...
        return _call(function () {
          ...
          return _await(_invoke(function () {
            if (!_this4._isAdditionalFolderQueryNeeded(query)) {
              return _await(_this4._doExecuteSearchQuery(query), function (_await$_this4$_doExec) {
                _exit = true;
                return _await$_this4$_doExec;
              });
            }
          }, function (_result) {
            if (_exit) return _result;

            var additionalFolderQuery = _this4._assembleAdditionalFolderQuery(query);

            return _await(_this4._doExecuteSearchQuery(query), function (_this4$_doExecuteSear) {
              return _await(_this4._doExecuteSearchQuery(additionalFolderQuery), function (_this4$_doExecuteSear2) {
                return _await(Promise.all([_this4$_doExecuteSear, _this4$_doExecuteSear2]), function (_ref) {
                  var _ref2 = _slicedToArray(_ref, 2),
                      resultSet = _ref2[0],
                      addtionalResultSet = _ref2[1];

                  var mergedResultSet = _this4._mergeResultSetsInNavigationFolderMode(resultSet, addtionalResultSet);
      ...
      value: function _assembleAdditionalFolderQuery(query) {
        ...
        additionalFolderQuery.calculateFacets = false; // collect descendat-of filter conditions for folder attribute
      ...
      value: function _doExecuteSearchQuery(query) {
        ...
        return _call(function () {
          var transformedQuery = _this5._filteredQueryTransform(query);

          return _await(_this5.sina.provider.executeSearchQuery(transformedQuery), function (resultSet) {
            return _this5._filteredQueryBackTransform(query, resultSet);
          });
        });
      }
    }, {
      ...
      value: function _formatResultSetAsync(resultSet) {
        ...
        return _call(function () {
          return _await(core.executeSequentialAsync(_this6.sina.searchResultSetFormatters, function (formatter) {
      ...
      value: function _collectAttributesWithFilter(query) {
        ...
        var attributedIds = Object.keys(attributeMap); // filter out hierarchy attributes
      ...
      value: function _addSelectedFiltersToSearchResultSet(searchResultSet) {
        ...
        for (var j = 0; j < rootCondition.conditions.length; j++) {
          ...
          for (var k = 0; k < conditions.length; k++) {
            var matchFacetItemIndex = void 0; // check in searchResultSet facets
      ...
      value: function _addChartResultSetToSearchResultSet(searchResultSet, chartResultSet) {
        ...
        var matchFacet = searchResultSet.facets[matchFacetIndex]; // selected facet items for this dimension

        var selectedFacetItemList = matchFacet.items; // merge selected facet items to chartResultSet
