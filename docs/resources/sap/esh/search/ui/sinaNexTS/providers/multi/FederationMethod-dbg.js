...
sap.ui.define([], function () {
  ...
  var Ranking = /*#__PURE__*/function () {
    ...
    _createClass(Ranking, [{
      key: "sort",
      value: //sorting method according ranking
  ...
  var RoundRobin = /*#__PURE__*/function () {
    ...
    _createClass(RoundRobin, [{
      key: "sort",
      value: //simple round robin method
      function sort(resultSetItemList) {
        var sortedResults = [];
  ...
  var AdvancedRoundRobin = /*#__PURE__*/function () {
    ...
    _createClass(AdvancedRoundRobin, [{
      key: "sort",
      value: //advanced round robin method
      function sort(resultSetItemList) {
        var results = [];
        ...
        var dataSourceId; //result list map, key: dataSourceId, value: array list of resultlist
