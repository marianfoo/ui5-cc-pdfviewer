    ...
    _createClass(MetadataParser, [{
      ...
      value: function _fillMetadataBufferForDataSource(dataSource, attributes) {
        ...
        for (i = 0; i < attributes.length; i++) {
          ...
          var publicAttributeMetadata = this._fillMetadataBufferForAttribute(dataSource, attributeMetadata); // Prepare attribute annotations for being passed over to the CDS annotations parser
          ...
          cdsAnnotations.attributeAnnotations[publicAttributeMetadata.id.toUpperCase()] = attributeAnnotations; // if this attribute has a Semantics property but no semantics annotation, create a new semantics annotation that corresponds to Semantics property.
      ...
      value: function _fillMetadataBufferForAttribute(dataSource, attributeMetadata) {
        ...
        publicAttributeMetadata._private.semanticObjectType = attributeMetadata.SemanticObjectTypeId; // temporaly store usage in this property.
      ...
      value: function _parseAnnotationsIntoJsonStructure(annotations) {
        ...
        try {
          ...
          var dummyArrayKeyRegex = /\[\d+\]/g; // second step: replace dummy arrays with real arrays
      ...
      value: function _parseUsage(attributeMetadata, displayOrderIndex) {
        ...
        usagesInResponse.forEach(function (elem) {
          ...
          if (id === "DETAILS" || id === "LONGTEXT" //||id === "#HIDDEN"
          ) {
            usage.Detail = {
              displayOrder: displayOrderIndex
            };
