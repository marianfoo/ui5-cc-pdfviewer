...
sap.ui.define(["../../sina/NavigationTarget", "./template_metadata", "./template_details_folklorists", "./template_details_legends", "./template_details_publications"], function (____sina_NavigationTarget, ___template_metadata, ___template_details_folklorists, ___template_details_legends, ___template_details_publications) {
  ...
  function createTemplate(oContext) {
    ...
    if (oContext.sina) {
      ...
      gen.metadata = createTemplateMetadata(oContext).metadata; //metadata for legends

      gen.metadata2 = createTemplateMetadata(oContext).metadata2; //metadata for legends
    ...
    if (oContext.searchQuery && oContext.searchQuery.filter && oContext.searchQuery.filter.dataSource && oContext.sina && oContext.sina.getDataSource("Folklorists")) {
      ...
      detailAttributes = createTemplateDetailsPublications(oContext, gen).alligatorbook; //if (addTestCaseSuvs) {
      ...
      detailAttributes = createTemplateDetailsPublications(oContext, gen).slendermanbook; // if (addTestCaseSuvs) {
      //     suvPath = "/fileviewer-testdata/spiegel.suv";
      //searchTermsArray = ["said", "aware"];
      //    oContext.addSuvLinkToSearchResultItem(detailAttributes[0], suvPath, searchTermsArray);
      // } else {
      //oContext.addSuvLinkToSearchResultItem(detailAttributes[0],
      //    '/resources/sap/esh/search/ui/sinaNexTS/providers/sample/docs/test2.suv', ['assignment', 'sign']);
      ...
      detailAttributes = createTemplateDetailsPublications(oContext, gen).chupacabrabook; //if (addTestCaseSuvs) {
