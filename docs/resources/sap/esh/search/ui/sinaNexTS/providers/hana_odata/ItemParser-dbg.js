...
(function(){
sap.ui.define(["../../core/util", "./typeConverter", "../../core/Log", "../../core/errors", "../tools/WhyfoundProcessor"], function (util, typeConverter, ____core_Log, ____core_errors, ___tools_WhyfoundProcessor) {
    ...
    _createClass(ItemParser, [{
      ...
      value: function parseItem(itemData, query) {
        ...
        return _call(function () {
          ...
          var dataSource = (_this2$sina$getDataSo = _this2.sina.getDataSource(entitySetName)) !== null && _this2$sina$getDataSo !== void 0 ? _this2$sina$getDataSo : query.getDataSource();
          ...
          var whyFoundProcessor = new WhyfoundProcessor(_this2.sina); // parse attributes
          ...
          for (var attributeName in itemDataStructured) {
            ...
            util.appendRemovingDuplicates(suvHighlightTerms, util.extractHighlightedTerms(attribute.valueHighlighted)); // deprecated as of 1.92 since fileviewer is also deprecated
