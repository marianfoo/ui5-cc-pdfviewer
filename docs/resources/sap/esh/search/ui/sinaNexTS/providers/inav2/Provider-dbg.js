...
sap.ui.define(["../AbstractProvider", "../../core/core", "./conditionSerializer", "./dataSourceSerializer", "../../core/util", "../../core/lang", "../../core/ajax", "./ajaxTemplates", "./labelCalculation", "./pivotTableParser", "./suggestionParser", "./suggestionTermSplitter", "./UserEventLogger", "./MetadataParser", "./ItemParser", "./FacetParser", "../../sina/AttributeType", "../../core/errors"], function (___AbstractProvider, core, conditionSerializer, dataSourceSerializer, util, lang, ____core_ajax, ajaxTemplates, labelCalculation, pivotTableParser, suggestionParser, suggestionTermSplitter, ___UserEventLogger, ___MetadataParser, ___ItemParser, ___FacetParser, ____sina_AttributeType, ____core_errors) {
  ...
  var Provider = /*#__PURE__*/function (_AbstractProvider) {
    ...
    function Provider() {
      ...
      _defineProperty(_assertThisInitialized(_this4), "id", "inav2");
    ...
    _createClass(Provider, [{
      ...
      value: function initAsync(configuration) {
        ...
        return this.loadServerInfo().then(function (serverInfo) {
          _this5.serverInfo = serverInfo;

          _this5.userEventLogger.delayedInit();

          if (!_this5.supports("Search")) {
            return Promise.reject(new ESHNotActiveError("Enterprise Search is not active"));
          }

          return _this5.loadBusinessObjectDataSources();
        }).then(function () {
          return {
            capabilities: _this5.sina._createCapabilities({
              fuzzy: _this5.supports("Search", "OptionFuzzy")
            })
          };
        });
      }
      ...
      value: function loadBusinessObjectDataSources() {
        ...
        var that = this;
        that.addLanguagePreferences(ajaxTemplates.loadDataSourcesRequest); // description plural in capability -> add description plural property in request
      ...
      value: function _processDataSourcesResponse(response, isFallback) {
        ...
        for (var i = 0; i < dataSourcesData.length; ++i) {
          ...
          var dataSource = this.sina._createDataSource({
            ...
            type: this.sina.DataSourceType.BusinessObject // attributesMetadata: [{
            //     id: "dummy"
      ...
      value: function executeSearchQuery(query) {
        var parsedItems, response; // assemble json request
      ...
      value: function executeChartQuery(query) {
        ...
        this.addSessionId(ajaxTemplates.chartRequest); // fire request
      ...
      value: function executeSuggestionQuery(query) {
        ...
        return _call(function () {
          ...
          var splittedTerm = suggestionTermSplitter.split(_this, searchTerm); // add search term to condition
          ...
          ajaxTemplates.suggestionRequest.Options = _this.assembleSuggestionOptions(query);

          if (ajaxTemplates.suggestionRequest.Options.length === 0) {
            return _await(_this.sina._createSuggestionResultSet({
              title: "Suggestions",
              query: query,
              items: []
            }));
          ...
          _this.addLanguagePreferences(ajaxTemplates.suggestionRequest);

          _this.addSessionId(ajaxTemplates.suggestionRequest); // fire request


          return _await(_this.ajaxClient.postJson(_this.getResponseUrl, ajaxTemplates.suggestionRequest).then(function (response) {
      ...
      value: function getConfigurationAsync() {
        ...
        return _call(function () {
          return _this2.supports("PersonalizedSearch", "SetUserStatus") ? _await(_this2.ajaxClient.postJson(_this2.getResponseUrl, ajaxTemplates.getConfigurationRequest).then(function (response) {
            var config = {
          ...
          }.bind(_this2))) : Promise.resolve(_this2.sina._createConfiguration({
            personalizedSearch: false,
            isPersonalizedSearchEditable: false
          }));
        });
      ...
      value: function saveConfigurationAsync(configuration) {
        ...
        return _call(function () {
          if (!_this3.supports("PersonalizedSearch", "SetUserStatus")) {
            return Promise.resolve();
          }
          ...
          return _await(_this3.ajaxClient.postJson(_this3.getResponseUrl, ajaxTemplates.saveConfigurationRequest));
        });
      }
    }, {
