...
sap.ui.define(["../../sina/SinaObject", "../../core/util", "./typeConverter", "../tools/WhyfoundProcessor"], function (____sina_SinaObject, util, typeConverter, ___tools_WhyfoundProcessor) {
  ...
  var ItemParser = /*#__PURE__*/function (_SinaObject) {
    ...
    function ItemParser(provider) {
      ...
      _this2.sina = provider.sina;
      _this2.intentsResolver = _this2.sina._createFioriIntentsResolver();
      _this2.suvNavTargetResolver = _this2.sina._createSuvNavTargetResolver();
      return _this2;
    }
    ...
    _createClass(ItemParser, [{
      ...
      value: function parseItem(itemData) {
        ...
        return _call(function () {
          ...
          var dataSource = _this.sina.getDataSource(itemData.DataSourceId);
          ...
          var suvAttributes = {};
          var whyFounds = {};
          var whyFoundProcessor = new WhyfoundProcessor(_this.sina);
          ...
          for (j = 0; j < itemData.Attributes.results.length; j++) {
            ...
            attribute = _this.sina._createSearchResultSetItemAttribute({
              id: attributeData.Id,
            ...
            allAttributes[attribute.id] = attribute; // collect highlight terms needed for creation of suv viewer link
            ...
            if (metadata.usage.Navigation) {
              if (metadata.usage.Navigation.mainNavigation) {
                fallbackDefaultNavigationTarget = _this.sina._createNavigationTarget({
            ...
            if (attribute.isHighlighted || attribute.descriptionAttribute && attribute.descriptionAttribute.isHighlighted) {
              if (!_this._isVisible(metadata) && typeof whyFounds[attribute.id] === "undefined") {
          ...
          _this.suvNavTargetResolver.resolveSuvNavTargets(dataSource, suvAttributes, suvHighlightTerms);

          var searchResultSetItem = _this.sina._createSearchResultSetItem({
          ...
          var itemPostParser = _this.sina._createItemPostParser({
          ...
          return _await(itemPostParser.postParseResultSetItem(), function (postResultSetItem) {
            whyFounds = _this._pushAdditionalWhyFounds(itemData, whyFounds, ungrouppedDetailAttributes); // push request attributes (highlighted and not visible) to whyFounds
