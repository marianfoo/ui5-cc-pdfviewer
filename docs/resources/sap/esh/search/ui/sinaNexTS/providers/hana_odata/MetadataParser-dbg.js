  ...
  var MetadataParser = /*#__PURE__*/function () {
    ...
    _createClass(MetadataParser, [{
      ...
      value: function _setAnnotationValue(annotations, annotationName, value) {
        ...
        var i; // Step 01: create object structure for annoation
      ...
      value: function fillPublicMetadataBuffer(dataSource, attributeMetadata, cdsAnnotations) {
        var displayOrderIndex = attributeMetadata.displayOrder; // Prepare annotations for being passed over to the CDS annotations parser

        var attributeAnnotations = cdsAnnotations.attributeAnnotations[attributeMetadata.labelRaw] = {}; // var attributeAnnotationsSrc = attributeMetadata.annotationsAttr;
      ...
      value: function _parseUsage(attributeMetadata, displayOrderIndex) {
        ...
        for (var i = 0; i < attributeMetadata.presentationUsage.length; i++) {
          ...
          if (id === "SUMMARY" || id === "DETAIL" || id === "IMAGE" || id === "THUMBNAIL" || id === "LONGTEXT" //||id === "#HIDDEN"
          ) {
            usage.Detail = {
              displayOrder: displayOrderIndex
            };
