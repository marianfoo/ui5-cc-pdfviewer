  ...
  var MetadataParser = /*#__PURE__*/function () {
    ...
    _createClass(MetadataParser, [{
      ...
      value: function parseMetadataRequestMetadata(dataSource, data) {
        ...
        this.parseResponseAttributes(dataSource, data); // fill public metadata from internal metadata
      ...
      value: function parseSearchRequestMetadata(itemData) {
        ...
        var dataSource = this.sina.getDataSource(itemData.$$DataSourceMetaData$$[0].ObjectName); // check whether buffer already filled
        ...
        this.provider.fillInternalMetadata(dataSource, "searchRequest", itemData.$$AttributeMetadata$$); // fill public metadata from internal metadata

        this.fillPublicMetadataBuffer(dataSource); // calculate attribute display sequence from sequence in result item
      ...
      value: function fillPublicMetadataBuffer(dataSource) {
        ...
        dataSource.attributeMetadataMap = {}; // create new public metadata
      ...
      value: function calculateAttributeDisplayOrder(dataSource, itemData) {
        ...
        var detailAttributes = []; // distribute attributes in lists according to presentationUsage
