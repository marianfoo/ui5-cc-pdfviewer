...
(function(){
sap.ui.define(["../../../UIUtil", "../../core/errors", "../../sina/UserCategoryDataSource", "../AbstractProvider", "./template", "./template2"], function (_____UIUtil, ____core_errors, ____sina_UserCategoryDataSource, ___AbstractProvider, ___template, ___template2) {
    ...
    _createClass(Provider, [{
      ...
      value: function initAsync(properties) {
        ...
        return _call(function () {
          ...
          _this.templateProvider = template; // the newer template, folklorists

          if (document.location.href.indexOf("use=sample1") > 0) {
            _this.templateProvider = template2; // the original template, scientists
          }

          var demoRoot = _this.templateProvider(_this);
      ...
      value: function adjustHighlights(items, searchTerm) {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          for (var k = 0; k < item.titleAttributes.length; k++) {
            ...
            attrMetadataType = titleAttr.metadata.type; //  KLUDGE!! ImageUrl added to the following for publications / document links
      ...
      value: function executeSearchQuery(searchQuery) {
        ...
        return _call(function () {
          _this2.searchQuery = searchQuery;
          return _await(new Promise(function (resolve) {
            ...
            if (dataSourceId === "Scientists" || dataSourceId === "Folklorists") {
              ...
              items = _this2.applyFilters(items, searchQuery); // top/skip
      ...
      value: function executeSuggestionQuery(query) {
        ...
        return _call(function () {
          ...
          var demoRoot = _this3.templateProvider(_this3);
          ...
          var suggestionTerms = _this3.getSuggestionList(searchAbleItems); // "Sally Spring,Galapagos,Female,Barry Williamson,Off East Cyprus,Male,Conrad Atkinson,Baalbek, Lebanon,Roger Murdoch,Wycliffe Well"
          ...
          var resultSet = _this3.sina._createSuggestionResultSet({
            title: "Suggestions",
            query: query,
            items: suggestions
          });
      ...
      value: function executeChartQuery(query) {
        ...
        return _call(function () {
          var chartResultSetItems = _this4.generateFacets(query);
      ...
      value: function generateFacets(searchQuery) {
        ...
        var chartResultSetItems = [];
        var resultSetItemsArray; // get the right resultsetitems
