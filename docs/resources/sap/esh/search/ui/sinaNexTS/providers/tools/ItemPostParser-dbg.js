...
sap.ui.define(["../../sina/SinaObject", "../../sina/AttributeType", "../abap_odata/Provider"], function (____sina_SinaObject, ____sina_AttributeType, ___abap_odata_Provider) {
  ...
  var ItemPostParser = /*#__PURE__*/function (_SinaObject) {
    ...
    function ItemPostParser(properties) {
      ...
      _this3._searchResultSetItem = properties.searchResultSetItem;
      _this3._dataSource = properties.searchResultSetItem.dataSource;
      _this3._allAttributesMap = properties.searchResultSetItem._private.allAttributesMap;
      _this3._intentsResolver = _this3.sina._createFioriIntentsResolver({
    ...
    _createClass(ItemPostParser, [{
      ...
      value: function postParseResultSetItem() {
        ...
        return _call(function () {
          var prom = _this.enhanceResultSetItemWithNavigationTargets(); // TODO: what about exceptions?


          _this.enhanceResultSetItemWithGroups(); // can be done in parallel, if parallelization is possible
      ...
      value: function enhanceResultSetItemWithNavigationTargets() {
        ...
        return _call(function () {
          ...
          return _await(that._intentsResolver.resolveIntents({
            ...
            _this2.enhanceNavigationTargetsWithContentProviderId(navigationTargetForEnhancement);
