  ...
  var UserEventLogger = /*#__PURE__*/function () {
    ...
    _createClass(UserEventLogger, [{
      ...
      value: function logUserEvent(event) {
        event.timeStamp = util.generateTimestamp(); // regular interaction logging
      ...
      value: function incrementClickCounter(sourceUrlArray, targetUrl, systemAndClient) {
        ...
        var NavigationEventList = ajaxTemplates.incrementClickCounterRequest.SearchConfiguration.ClientEvent.NavigationEventList; // source application
        ...
        NavigationEventList[0].SourceApplication.ParameterList = sourceParameterList; // target application
