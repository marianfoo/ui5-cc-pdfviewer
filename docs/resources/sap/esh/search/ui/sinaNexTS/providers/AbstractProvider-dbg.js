...
sap.ui.define(["../sina/SinaObject"], function (___sina_SinaObject) {
  ...
  var AbstractProvider = /*#__PURE__*/function (_SinaObject) {
    ...
    _createClass(AbstractProvider, [{
      key: "getDebugInfo",
      value: // abstract supports(service: any, capability: any): boolean;
      ...
      value: function resetPersonalizedSearchDataAsync( // eslint-disable-next-line @typescript-eslint/no-unused-vars
      config) {
