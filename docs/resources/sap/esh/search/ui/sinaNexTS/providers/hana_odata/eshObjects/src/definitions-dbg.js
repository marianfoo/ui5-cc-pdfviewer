...
sap.ui.define([], function () {
  ...
  var escapePhrase = function escapePhrase(value) {
    ...
    returnValue = returnValue.replace(/"/g, '\\"'); // returnValue = returnValue.replace(/\*/g, '\\*'); // do not escape *
  ...
  var PropertyAlias = /*#__PURE__*/function () {
    ...
    _createClass(PropertyAlias, [{
      key: "toStatement",
      value: function toStatement() {
        return "".concat(this.path.join("."), " ").concat(this.alias); // return `${this.path.map((item)=> "\"" + escapeDoubleQuoteAndBackslash(item) + "\"").join(".")} ${this.alias}`;
      }
    }]);
  ...
  var Alias = /*#__PURE__*/function () {
    ...
    _createClass(Alias, [{
      key: "toStatement",
      value: function toStatement() {
        return "".concat(this.type, " ").concat(this.alias); // return `"${escapeDoubleQuoteAndBackslash(this.type)}" ${this.alias}`;
      }
    }]);
