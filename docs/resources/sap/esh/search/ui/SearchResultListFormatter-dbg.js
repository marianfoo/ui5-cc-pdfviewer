...
sap.ui.define(["sap/esh/search/ui/SearchNavigationObject", "sap/esh/search/ui/SearchNavigationObjectForSinaNavTarget", "./SearchResultBaseFormatter", "./sinaNexTS/providers/abap_odata/UserEventLogger"], function (SearchNavigationObject, SearchNavigationObjectForSinaNavTarget, __SearchResultBaseFormatter, ___sinaNexTS_providers_abap_odata_UserEventLogger) {
  ...
  var SearchResultListFormatter = /*#__PURE__*/function (_SearchResultBaseForm) {
    _inherits(SearchResultListFormatter, _SearchResultBaseForm);

    var _super = _createSuper(SearchResultListFormatter);

    function SearchResultListFormatter(model) {
      var _this;

      _classCallCheck(this, SearchResultListFormatter);
    ...
    _createClass(SearchResultListFormatter, [{
      key: "format",
    ...
    return SearchResultListFormatter;
