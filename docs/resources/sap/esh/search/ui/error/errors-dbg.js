...
sap.ui.define(["../i18n"], function (__i18n) {
  ...
  var UnknownDataSourceType = /*#__PURE__*/function (_ESHUIError2) {
    _inherits(UnknownDataSourceType, _ESHUIError2);

    var _super3 = _createSuper(UnknownDataSourceType);
  ...
  var UnknownFacetType = /*#__PURE__*/function (_ESHUIError3) {
    _inherits(UnknownFacetType, _ESHUIError3);

    var _super4 = _createSuper(UnknownFacetType);
  ...
  var ProgramError = /*#__PURE__*/function (_ESHUIError4) {
    _inherits(ProgramError, _ESHUIError4);

    var _super5 = _createSuper(ProgramError);
