  ...
  var ErrorHandler = /*#__PURE__*/function () {
    ...
    _createClass(ErrorHandler, [{
      ...
      value: function defaultErrorHandler(error) {
        ...
        var details = i18n.getText("error.details"); // special error handling, should only be necessary if not already done in errors.js:
        ...
        if (typeof this.searchModel === "undefined" || this.searchModel === null) {
          ...
          this._addUI5LogMessage(error, title); // open a messagebox as last resort:
        ...
        this.searchModel.setProperty("/isBusy", false); // const stripUi5 = (text:string):string => {
        //     return text.replace(/<(?:.|\n)*?>|[{}]/gm, "");
        // };

        this._addUI5LogMessage(error, title); // create an error description which includes a solution:
