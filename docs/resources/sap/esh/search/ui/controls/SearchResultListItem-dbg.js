...
sap.ui.define(["../i18n", "sap/esh/search/ui/controls/SearchText", "sap/esh/search/ui/controls/SearchLink", "sap/esh/search/ui/SearchHelper", "sap/esh/search/ui/controls/SearchRelatedObjectsToolbar", "sap/m/Button", "sap/m/library", "sap/m/Label", "sap/m/Text", "sap/m/CheckBox", "sap/ui/core/Icon", "sap/ui/core/IconPool", "sap/ui/core/InvisibleText", "sap/ui/core/Control", "../sinaNexTS/providers/abap_odata/UserEventLogger", "../UIUtil"], function (__i18n, SearchText, SearchLink, SearchHelper, SearchRelatedObjectsToolbar, Button, sap_m_library, Label, Text, CheckBox, Icon, IconPool, InvisibleText, Control, ___sinaNexTS_providers_abap_odata_UserEventLogger, ___UIUtil) {
  ...
  var SearchResultListItem = Control.extend("sap.esh.search.ui.controls.SearchResultListItem", {
    ...
    constructor: function _constructor(settings) {
      ...
      this.setAggregation("_titleLink", new SearchLink().addStyleClass("sapUshellSearchResultListItem-HeaderEntry").addStyleClass("sapUshellSearchResultListItem-Title").addStyleClass("sapUshellSearchResultListItem-MightOverflow").attachPress(function (oEvent) {
      ...
      this.setAggregation("_titleLinkDescription", new SearchText().addStyleClass("sapUshellSearchResultListItem-HeaderEntry").addStyleClass("sapUshellSearchResultListItem-TitleDescription").addStyleClass("sapUshellSearchResultListItem-MightOverflow"));
      var titleDelimiter = new Text({
        text: "|"
      });
      ...
      this.setAggregation("_typeText", new SearchText().addStyleClass("sapUshellSearchResultListItem-HeaderEntry").addStyleClass("sapUshellSearchResultListItem-TitleCategory").addStyleClass("sapUshellSearchResultListItem-MightOverflow"));
      this.setAggregation("_typeLinkAriaDescription", new InvisibleText({
        text: i18n.getText("result_list_item_type_link_description")
      }));
      this.setAggregation("_typeLink", new SearchLink().addStyleClass("sapUshellSearchResultListItem-HeaderEntry").addStyleClass("sapUshellSearchResultListItem-TitleCategoryLink").addStyleClass("sapUshellSearchResultListItem-MightOverflow").addAriaDescribedBy(this.getAggregation("_typeLinkAriaDescription")) // ToDo
      );
      this.setAggregation("_multiLineDescriptionText", new SearchText("", {
        maxLines: 5
      ...
      this.setAggregation("_selectionCheckBox", new CheckBox({
        select: function select(oEvent) {
          _this.setProperty("selected", oEvent.getParameter("selected"), true
          /*no re-rendering needed, change originates in HTML*/
      ...
      this.setAggregation("_expandButton", new Button({
        type: ButtonType.Transparent,
        press: function press() {
          _this.toggleDetails();
        }
      }));
      this.setAggregation("_relatedObjectActionsToolbar", new SearchRelatedObjectsToolbar());
    ...
    _renderContainer: function _renderContainer(oRm) {
      ...
      this._renderContentContainer(oRm);
    ...
    _renderTitleContainer: function _renderTitleContainer(oRm) {
      ...
      this._renderCheckbox(oRm); /// Title
      ...
      } else if (oModel.config.FF_optimizeForValueHelp) {// do not navigate
        // do not set 'href'
      } else {
      ...
      if (this.getProperty("titleIconUrl") && this.getProperty("titleIconUrl")) {
        var oIcon = new Icon({
      ...
      if (this.getProperty("titleInfoIconUrl")) {
        var oInfoIcon = new Icon({
          src: this.getProperty("titleInfoIconUrl")
        });
        oInfoIcon.addStyleClass("sapUshellSearchResultListItem-TitleInfoIcon");

        if (oModel.config.FF_optimizeForValueHelp) {
          oInfoIcon.addStyleClass("sapUshellSearchResultListItem-TitleInfoIconValueHelp");
        }

        oRm.renderControl(oInfoIcon);
      ...
      if (oModel.config.FF_optimizeForValueHelp) {
        ...
        oRm.renderControl(titleDelimiter); /// object type
      ...
      if (((_this$getProperty2 = this.getProperty("imageFormat")) === null || _this$getProperty2 === void 0 ? void 0 : _this$getProperty2.toLowerCase()) === "documentthumbnail") {
        ...
        if ((description === null || description === void 0 ? void 0 : (_description$value = description.value) === null || _description$value === void 0 ? void 0 : _description$value.length) > 0) {
          ...
          if (description.valueWithoutWhyfound) {
            ...
            this.addAggregation("_attributeValuesWithoutWhyfoundHiddenTexts", hiddenValueText, true
    ...
    _renderAttributesContainer: function _renderAttributesContainer(oRm) {
      ...
      if (!oModel.config.FF_optimizeForValueHelp) {
        this._renderImageAttribute(oRm,
        /* imageIsOnlyAttribute= */
        itemAttributes.length === 0);
      }

      this._renderAllAttributes(oRm, itemAttributes); // this is just a dummie attribute to store additional space information for the expand and collapse JavaScript function
    ...
    _renderAllAttributes: function _renderAllAttributes(oRm, itemAttributes) {
      ...
      this.setProperty("layoutCache", layoutCache,
      /* suppress rerender */
      true);
      ...
      var includeImageAttribute = this.getProperty("imageUrl") && !isDocumentItem && !oModel.config.FF_optimizeForValueHelp;

      if (isDocumentItem && !oModel.config.FF_optimizeForValueHelp) {
      ...
      this.destroyAggregation("_attributeValuesWithoutWhyfoundHiddenTexts"); // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      for (; !(additionalWhyFoundAttributesDesktop <= 0 && additionalWhyFoundAttributesTablet <= 0) && i < itemAttributes.length; i++) {
        ...
        if (_oModel.config.FF_optimizeForValueHelp && !itemAttribute.whyfound) {
        ...
        if (_oModel.config.FF_optimizeForValueHelp) {
          oRm["class"]("sapUshellSearchResultListItem-GenericAttributeValueHelp");
        }
        ...
        oRm.close("span");
        oRm.close("li");
        this.addAggregation("_attributeLabels", label, true
        /* do not invalidate this object */
        );
        this.addAggregation("_attributeValues", value, true
        /* do not invalidate this object */
        );
    ...
    _renderAccessibilityInformation: function _renderAccessibilityInformation(oRm) {
      ...
      if (parentListItem) {
        this._renderAriaDescriptionElementForTitle(oRm,
        /* withPrefix = */
        true,
        /* doRender= */
        true);

        this._renderAriaDescriptionElementForAttributes(oRm,
        /* withPrefix = */

        /* doRender= */
        true);

        this._renderAriaDescriptionElementForCollapsedOrExpandedState(oRm,
        /* withPrefix = */
        ...
        parentListItem.addEventDelegate({
          onAfterRendering: function onAfterRendering() {
            ...
            _this5._addAriaDescriptionToParentListElement(parentListItem,
            /* includeTotalCountElement = */
            true);
            ...
            registerHandler("acc-listitem-focusin", $parentListItem, "focusin", function (event) {
              ...
              if ($relatedTarget.hasClass("sapUshellSearchResultListItem") || $relatedTarget.closest(".sapUshellSearchResultListItemApps").length > 0 && !$relatedTarget.hasClass("sapUshellResultListMoreFooter")) {
                _this5._renderAriaDescriptionElementForTitle(oRm,
                /* withPrefix = */
                false,
                /* doRender= */
                false);

                _this5._renderAriaDescriptionElementForAttributes(oRm,
                /* withPrefix = */

                /* doRender= */
                false);

                _this5._renderAriaDescriptionElementForCollapsedOrExpandedState(oRm,
                /* withPrefix = */
    ...
    _getExpandAreaObjectInfo: function _getExpandAreaObjectInfo() {
      ...
      if (relatedObjectsToolbar.css("display") === "none" && !oModel.config.FF_optimizeForValueHelp) {
        relatedObjectsToolbar.css("display", "block");
      ...
      var animation01 = expandAreaObjectInfo.attributesExpandContainer["animate"]({
        ...
        progress: function progress(animation, _progress, remainingMs) {
          if (!secondAnimationStarted && _progress > 0.5) {
            ...
            secondAnimationStarted = true; // eslint-disable-next-line @typescript-eslint/no-this-alias

            jQuery.when(animation01, animation02).done( // jQuery Deferred for jQuery Animation, Unable to convert to Promise
            function () {
              ...
              that._renderAriaDescriptionElementForAttributes(undefined,
              /* withPrefix = */

              /* doRender= */
              false);

              that._renderAriaDescriptionElementForCollapsedOrExpandedState(undefined,
              /* withPrefix = */
    ...
    hideDetails: function _hideDetails() {
      ...
      expandAreaObjectInfo.relatedObjectsToolbar["animate"]( // ToDo
      {
        opacity: 0
        ...
        progress: function progress(animation, _progress2, remainingMs) {
          if (!secondAnimationStarted && remainingMs <= expandAreaObjectInfo.fadeInOrOutAnimationDuration) {
            ...
            jQuery.when(deferredAnimation01, deferredAnimation02).done(function () {
              ...
              expandAreaObjectInfo.attributesExpandContainer["removeClass"]( // ToDo
              ...
              _this6._renderAriaDescriptionElementForAttributes(undefined,
              /* withPrefix = */

              /* doRender= */
              false);

              _this6._renderAriaDescriptionElementForCollapsedOrExpandedState(undefined,
              /* withPrefix = */
    ...
    onAfterRendering: function _onAfterRendering() {
      ...
      this._renderAriaDescriptionElementForTitle(undefined,
      /* withPrefix = */
      false,
      /* doRender= */
      false);

      this._renderAriaDescriptionElementForAttributes(undefined,
      /* withPrefix = */

      /* doRender= */
      false);

      this._renderAriaDescriptionElementForCollapsedOrExpandedState(undefined,
      /* withPrefix = */

      /* doRender= */
      false); // use boldtagunescape like in highlighting for suggestions // TODO
