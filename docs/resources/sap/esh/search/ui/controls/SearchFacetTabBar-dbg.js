  ...
  var SearchFacetTabBar = Control.extend("sap.esh.search.ui.controls.SearchFacetTabBar", {
    renderer: {
      ...
      render: function render(oRm, oControl) {
        var _oSearchModel$config7, _oSearchModel$config10;
        ...
        var createOpenFacetDialogFn = function createOpenFacetDialogFn(iSelectedTabBarIndex, aTabBarItems) {
          return function () {
            var dimension; // since UI5 reuses the showMore link control, we have to traverse the DOM
            ...
            oSearchFacetDialogModel.initBusinessObjSearch().then(function () {
              ...
              oDialog.setModel(oSearchModel, "searchModel"); // referece to page, so that dialog can be destroy in onExit()
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            if ( // shall be always true (prevent type-cast)
        ...
        if (oControl.getProperty("headerText")) {
          var _oSearchModel$config4, _oSearchModel$config5, _oSearchModel$config6;
          ...
          if ((_oSearchModel$config5 = oSearchModel.config) !== null && _oSearchModel$config5 !== void 0 && _oSearchModel$config5.FF_facetPanelUnifiedHeaderStyling && dimension === ((_oSearchModel$config6 = oSearchModel.config) === null || _oSearchModel$config6 === void 0 ? void 0 : _oSearchModel$config6.dimensionNameSpace_Description)) {
        ...
        var oListItem = new CustomListItem({
          content: contents[selectedButtonIndex] // the above line sadly removes the control from the searchFacetTabBar and relocates it in the ListItem
        ...
        if ((_oSearchModel$config7 = oSearchModel.config) !== null && _oSearchModel$config7 !== void 0 && _oSearchModel$config7.searchInAttibuteFacetPostion[dimension]) {
          var _oSearchModel$config8;

          if ((_oSearchModel$config8 = oSearchModel.config) !== null && _oSearchModel$config8 !== void 0 && _oSearchModel$config8.FF_facetPanelUnifiedHeaderStyling) {
            var _oSearchModel$config9;

            if (dimension === ((_oSearchModel$config9 = oSearchModel.config) === null || _oSearchModel$config9 === void 0 ? void 0 : _oSearchModel$config9.dimensionNameSpace_Description)) {// do not hide
            } else {
        ...
        var linkText = i18n.getText("showMore"); // DWC space facet

        if (dimension === ((_oSearchModel$config10 = oSearchModel.config) === null || _oSearchModel$config10 === void 0 ? void 0 : _oSearchModel$config10.dimensionNameSpace_Description)) {
        ...
        oList.data("sap-ui-fastnavgroup", "false", true
        /* write into DOM */
        );
    ...
    storeClickedTabInformation: function _storeClickedTabInformation(oEvent) {
      ...
      var obj = {};
      obj.tabId = tabId; // obj.searchFacetTabBarIndex = searchFacetTabBarInfo.searchFacetTabBarIndex;  // obsolete: property never filled
      ...
      oSearchModel.getPersonalizationStorageInstance().setItem("search-facet-panel-chart-state", clickedTabInformation); // also store information in model
