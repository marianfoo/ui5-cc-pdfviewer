...
(function(){
sap.ui.define(["sap/esh/search/ui/SearchHelper"], function (sap_esh_search_ui_SearchHelper) {
  ...
  var Highlighter = /*#__PURE__*/function () {
    ...
    _createClass(Highlighter, [{
      ...
      value: function highlightTextNode(node) {
        ...
        spanNode.innerHTML = jQuery["sap"].encodeHTML(testResult.sHighlightedText); // ToDo: jQuery["sap"]
