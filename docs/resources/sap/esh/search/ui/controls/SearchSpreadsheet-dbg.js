...
(function(){
sap.ui.define(["../i18n", "sap/ui/export/Spreadsheet", "sap/m/MessageBox", "sap/ui/core/mvc/Controller", "sap/esh/search/ui/SearchResultListFormatter"], function (__i18n, Spreadsheet, MessageBox, Controller, SearchResultListFormatter) {
  ...
  var SearchSpreadsheet = Controller.extend("sap.esh.search.ui.controls.SearchSpreadsheet", {
    ...
    startExport: function _startExport() {
      ...
      var successHandler = function successHandler(searchResultSet) {
        ...
        var formatter = new SearchResultListFormatter(_this2.model);
