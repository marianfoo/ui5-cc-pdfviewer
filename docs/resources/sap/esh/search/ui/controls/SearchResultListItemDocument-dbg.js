...
sap.ui.define(["../i18n", "sap/esh/search/ui/controls/SearchResultListItem", "sap/esh/search/ui/controls/SearchText", "sap/esh/search/ui/SearchHelper", "sap/ui/core/Icon", "sap/ui/core/IconPool", "sap/ui/core/format/DateFormat"], function (__i18n, SearchResultListItem, SearchText, SearchHelper, Icon, IconPool, DateFormat) {
  ...
  var SearchResultListItemDocument = SearchResultListItem.extend("sap.esh.search.ui.controls.SearchResultListItemDocument", {
    ...
    _renderTitleContainer: function _renderTitleContainer(oRm) {
      ...
      oRm.renderControl(titleLink); /// Object Type

      var typeText = this.getAggregation("_typeText");
      typeText.setText(this.getProperty("type"));
      oRm.renderControl(typeText); // close div sapUshellSearchResultListItem-TitleContainer

      oRm.close("div");

      if (!oModel.config.FF_optimizeForValueHelp) {
        this._renderImageForPhone(oRm); // close div sapUshellSearchResultListItem-TitleAndImageContainer
    ...
    _renderAttributesContainer: function _renderAttributesContainer(oRm) {
      ...
      this._renderDocAttributesContainer(oRm); // This is just a dummie attribute to store additional space information for the expand and collapse JavaScript function
      ...
      this._renderRelatedObjectsToolbar(oRm); // close div sapUshellSearchResultListItem-AttributesAndActions


      oRm.close("div"); // close div sapUshellSearchResultListItemDoc-AttributesExpandContainer
    ...
    _renderThumbnailContainer: function _renderThumbnailContainer(oRm) {
      ...
      if (this.getProperty("containsThumbnail") === true) {
        ...
        oRm.openEnd();
        oRm.close("img");
        oRm.close("a"); // close div for sapUshellSearchResultListItemDoc-ThumbnailContainerInner

        oRm.close("div"); // close div for sapUshellSearchResultListItemDoc-ThumbnailContainer
    ...
    _renderAllAttributes: function _renderAllAttributes(oRm, itemAttributes) {
      ...
      var valueText;
      var value;
      var oProperty; // skip first attribute which is the title attribute for the table
