...
sap.ui.define(["../i18n", "sap/esh/search/ui/SearchHelper", "./SuggestionType"], function (__i18n, SearchHelper, ___SuggestionType) {
  ...
  var AppSuggestionProvider = /*#__PURE__*/function () {
    function AppSuggestionProvider(options) {
      ...
      this.suggestionHandler = options.suggestionHandler; // decorate suggestion methods (decorator prevents request overtaking)
      ...
      value: function getSuggestions(filter) {
        ...
        return _call(function () {
          ...
          return _await(_this.suggestApplications(suggestionTerm), function (resultset) {
            ...
            var uiAppSuggestions = []; // set type, datasource and position
            ...
            uiAppSuggestions = uiAppSuggestions.slice(0, appSuggestionLimit); // if there are more apps available, add a "show all apps" suggestion at the end
