  ...
  var UserCategoryManager = /*#__PURE__*/function () {
    ...
    _createClass(UserCategoryManager, [{
      ...
      value: function initAsync() {
        ...
        this.setLastFavActive(this.isFavActive()); // convert subDataSources from personalizationStorage into sina datasources
      ...
      key: "save",
      value: function save() {
        var categoriesJson = []; // check change of subDataSources
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            var subDataSourceList = []; // add subDataSources (active)
        ...
        this.personalizationStorage.saveNotDelayed().then(function () {
          ...
          } else if ( //search not used and flag for 'Use Personalized Search Scope' changed --> refresh of search dropdown listbox OR
