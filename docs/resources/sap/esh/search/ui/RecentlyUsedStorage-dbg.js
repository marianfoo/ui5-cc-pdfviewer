    ...
    _createClass(RecentlyUsedStorage, [{
      ...
      value: function deleteAllItems() {
        ...
        return _call(function () {
          _this.personalizationStorage.deleteItem(_this.key);

          return _await(_this.personalizationStorage.save());
        });
      }
    }, {
      key: "assembleLabel",
      ...
      value: function addItem() {
        ...
        var found = items.some(function (item, index, items) {
          ...
          if (item.label === recentItem.label && item.icon === recentItem.icon) {
            _this2._oLogger.debug("Removing already existing item " + recentItem.label + " at pos " + index);
